        ...
        <div v-if="!isEditing">
          <b-card :title=title
            ...
            <b-row>
              ...
              <b-col md="6" class="my-1">
                  <b-button @click="onAddItem()" variant="primary" class="float-right">Crear un recurso de Gastos Generales</b-button>
              </b-col>
            </b-row>
...
import HandleItem from "./resource/HandleOverHead.vue"
...
export default {
    ...
    data() {
        return {
            ...
            currentPage:1,
            searchQuery: '',
            title: "Recurso de Gastos Generales",
            handleTitle: "",
            filtered_items: [],
            items: [],
            fields: [
                ...
                {key:'type_cost', label: 'Tipo', sortable: true},
    ...
    methods: {
      onAddItem() {
        this.isEditing = true
        this.action = "add"
        this.handleTitle = "Crear Recurso de Gasto General"
      },
      onEditItem(index) {
        this.isEditing = true
        this.action = 'edit'
        this.handleTitle = "Modificar Recurso de Gasto General"
        this.id = index
      },
      getItems(pag) {
        this.action = 'add'
